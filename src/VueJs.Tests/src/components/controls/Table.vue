<template>
    ...
    >
        ...
        <template slot="actions" slot-scope="row">
            ...
            <b-button size="sm" variant="warning" @click.stop="openEdit(row.item, row.index, $event.target)" class="mr-1">                
...
export default {
    ...
    props:['tblData', 'tblFields', 'onNextPage', 'onCreate', 'onUpdate', 'onDelete', 'onSearch'],
    methods: {
        openAdd(button) 
        {
           this.onCreate()
